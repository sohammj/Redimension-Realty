            ...
            {featuredProjects.map((project, index) => (
              ...
              >
                <div className="relative aspect-[16/9] overflow-hidden bg-[#d9d8d1]">
                  ...
                  <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,transparent_48%,rgba(3,17,38,0.28)_100%)]" />
                  ...
                  <span className="absolute bottom-4 right-4 text-[10px] font-bold tracking-[0.14em] text-white/80">
